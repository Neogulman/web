...
public class ProductForm extends ProductFormDesign {
   ...
   /* @Autowired
    ...
    private void init() {
        ...
        barcode.setCaption("바코드 번호");
        name.setCaption("상품명");
        locationX.setCaption("X좌표");
        locationY.setCaption("Y좌표");
        stock.setCaption("재고량");
        salesvolume.setCaption("판매량");
        type.setCaption("종류");
        brand.setCaption("브랜드");
        price.setCaption("가격");
        save.setCaption("수정");
