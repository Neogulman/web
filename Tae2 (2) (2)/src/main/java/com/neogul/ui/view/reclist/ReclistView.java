...
//	private reclistContainer reclistContainer;
	...
	public HorizontalLayout createTopBar() {
		...
		newreclist = new Button("추천 상품 등록");
			...
			gridcontainer3 = new BeanItemContainer<>(TB_Saleslist.class, sDao.fnList(si));
			 ...
			 int i,j,k,n=0;
	            ...
	            for(i=0;i<gridcontainer3.size();i++){
	               ...
	               ps[1][i]=gridcontainer3.getIdByIndex(i).getPhone();
	               ps[2][i]=gridcontainer3.getIdByIndex(i).getKnife();
	               ps[3][i]=gridcontainer3.getIdByIndex(i).getCider();
	               ps[4][i]=gridcontainer3.getIdByIndex(i).getApple();
	               ps[5][i]=gridcontainer3.getIdByIndex(i).getCable();
	               ps[6][i]=gridcontainer3.getIdByIndex(i).getHighhill();
	               ps[7][i]=gridcontainer3.getIdByIndex(i).getMouse();
	               ps[8][i]=gridcontainer3.getIdByIndex(i).getDoll();
	               ps[9][i]=gridcontainer3.getIdByIndex(i).getPencil();
	            }
